 ...
 */
const CLIENT_ID = '103965454967-nloliejfh9pt2l4tcp45im6g5noo66r5.apps.googleusercontent.com';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = 'B4piBzCCDuScfZk6RSxVsNG0';

/**
 * Optionally replace this with your application's name.
 */
const APPLICATION_NAME = "SafeTravel BO";

$client = new Google_Client();
$client->setApplicationName(APPLICATION_NAME);
$client->setClientId(CLIENT_ID);
$client->setClientSecret(CLIENT_SECRET);
$client->setRedirectUri("//{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}");
